import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as a,d as e,o as i}from"./app-C1twxy1c.js";const l={};function p(t,s){return i(),a("div",null,s[0]||(s[0]=[e(`<h1 id="gradle学习" tabindex="-1"><a class="header-anchor" href="#gradle学习"><span>Gradle学习</span></a></h1><h2 id="第三包管理历史" tabindex="-1"><a class="header-anchor" href="#第三包管理历史"><span>第三包管理历史</span></a></h2><p>早期没有项目管理工具时，对于项目所依赖的第三方包采用的事：拷贝三方jar包到本地，然后加入到lib目录下，这样做劣势不言而喻，管理复杂容易冲突。 后面就出现了第三方包管理工具</p><ul><li>Ant：2000年发布，纯java编写.</li><li>Maven：2004年发布，采用pom.xml管理项目</li><li>Gradle：2012年，google背书的一款项目管理工具</li></ul><p>在使用这三个工具之前，我们要了解一个Java 项目通常的构建步骤:</p><ol><li><strong>清理 (Clean)</strong>: 清理上一次的构建结果,删除生成的编译文件、JAR 包等。这一步确保构建过程从一个干净的状态开始。</li><li><strong>编译 (Compile)</strong>: 编译 Java 源代码文件,将其转换为字节码文件。这个步骤需要确保源码文件的语法正确,并且能够通过编译器的检查。</li><li><strong>测试 (Test)</strong>: 运行单元测试或集成测试,确保代码的功能正确。这个步骤可以在编译后立即执行,或者作为独立的构建阶段。</li><li><strong>打包 (Package)</strong>: 将编译好的字节码文件及其依赖的库,打包成可分发的格式,通常是 JAR、WAR 或 EAR 文件。这个步骤需要指定项目的主类及相关的配置信息。</li><li><strong>安装 (Install)</strong>: 将打包好的构件,安装到本地的仓库中,供其他项目使用。这个步骤适用于需要发布构件的情况。</li><li><strong>部署 (Deploy)</strong>: 将打包好的构件,部署到测试或生产环境的服务器上。这个步骤需要与目标环境的基础设施进行对接。</li></ol><p>假设我们有一个Java项目,需要构建并打包为一个可执行JAR包。</p><p>我们来看看这三种工具如何实现这个需求。</p><p>Ant</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>&lt;?xml version=&quot;1.0&quot; encoding=&quot;UTF-8&quot;?&gt;</span></span>
...
<span class="line"><span>    &lt;/target&gt;</span></span>
<span class="line"><span>&lt;/project&gt;</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Maven 发布于 2004 年。目的是解决使用 Ant 所带来的一些问题。Maven 也是使用 XML 作为构建配置的文件格式，不过文件结构却有了巨大的变化：</p><ul><li>Ant 需要开发者将执行 task 所需的全部命令都列出来</li><li>而 Maven 依靠约定并提供现成的可调用的目标</li></ul><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>&lt;?xml version=&quot;1.0&quot; encoding=&quot;UTF-8&quot;?&gt;</span></span>
...
<span class="line"><span>    &lt;/dependencies&gt;</span></span>
<span class="line"><span>&lt;/project&gt;</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Maven 主要解决了依赖管理的问题，然而使用 XML 的错误使它重蹈覆辙，实际上用 Maven 很难写出复杂、定制化的构建脚本，在大型项目中，它经常什么“特别的”事还没干就有几百行代码，甚至不如 Ant。</p><p>前辈们在反省前两种构建工具的错误之后，提出了 DSL （Domain Special Language, 领域专用语言）的概念，目标是设计一套能够解决特定领域问题的语言。在构建这方面，DSL 的一个成功案例就是 Gradle。</p><p>Gradle</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>plugins {</span></span>
...
<span class="line"><span>}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>现在大家项目使用的构建工具都是maven和Gradle了。</p><h2 id="项目结构" tabindex="-1"><a class="header-anchor" href="#项目结构"><span>项目结构</span></a></h2><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>├─build.gradle                        ①</span></span>
...
<span class="line"><span>//- \`mavenCentral()\` 是一个内置的方法,用于添加 Maven 中央仓库作为依赖源。</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>每一个<code>build.gradle</code>文件对应一个Project实例，我们在build.gradle中编写的内容，就相当于<code>Project</code>实例的属性或方法。</p><figure><img src="https://cdn.nlark.com/yuque/0/2024/png/27874700/1720611438865-d5875f74-5309-4b04-a29b-11862a69c6ab.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h3 id="属性设置" tabindex="-1"><a class="header-anchor" href="#属性设置"><span>属性设置</span></a></h3><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>group = &#39;com.it235&#39;</span></span>
...
<span class="line"><span>ext.prop2 = &quot;君哥聊编程&quot;</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="方法" tabindex="-1"><a class="header-anchor" href="#方法"><span>方法</span></a></h3><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>apply plugin: &#39;idea&#39;. //apply 应用零个或多个插件或脚本。</span></span>
...
<span class="line"><span>}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="插件" tabindex="-1"><a class="header-anchor" href="#插件"><span>插件</span></a></h3><p>插件可以封装一系列任务，例如 编译，测试，打包等。 IDEA、VsCode、Eclipse、Maven、Chrome等都是支持插件集成的工具。插件意味着扩展，Gradle只要定义好插件规范，各大厂商或个人开发者遵循这个规范就能开发出很多有用的插件，从而丰富Gradle生态。</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>plugins {</span></span>
<span class="line"><span>    id &#39;java&#39;</span></span>
<span class="line"><span>    id &#39;org.springframework.boot&#39; version &#39;2.7.0&#39;</span></span>
<span class="line"><span>}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这个示例中使用了两个插件:</p><ol><li><code>java</code> 插件 <ul><li>这个是 Gradle 内置的核心插件,提供了标准的 Java 项目构建功能,如编译、测试、打包等。</li><li>使用 <code>java</code> 插件后,Gradle 会自动应用这些常见的 Java 项目构建任务。</li></ul></li><li><code>org.springframework.boot</code> 插件 <ul><li>这是 Spring Boot 项目的专用插件,提供了构建 Spring Boot 应用所需的特殊功能。</li><li>这个插件不是 Gradle 自带的,而是由 Spring 团队提供的扩展插件。</li><li>使用这个插件可以方便地构建和打包 Spring Boot 应用程序。</li></ul></li></ol><h2 id="任务" tabindex="-1"><a class="header-anchor" href="#任务"><span>任务</span></a></h2><p>任务是gradle的最小执行单元，一个<code>build.gradle</code>是由一系列的task组成，重要性不言而喻。任务在 Gradle 的构建脚本(build.gradle)中定义,可以通过以下方式创建任务:</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>task clean {</span></span>
...
<span class="line"><span>}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这里就是使用了DSL的语言来替代了xml</p><h1 id="参考链接" tabindex="-1"><a class="header-anchor" href="#参考链接"><span>参考链接</span></a></h1><p>https://cloud.tencent.com/developer/article/1014645</p><p>https://www.it235.com/%E5%AE%9E%E7%94%A8%E5%B7%A5%E5%85%B7/Gradle/gradle.html#%E6%A6%82%E5%BF%B5</p>`,53)]))}const c=n(l,[["render",p],["__file","Gradle学习.html.vue"]]),o=JSON.parse('{"path":"/%E5%BC%80%E5%8F%91/Java%E5%BC%80%E5%8F%91/Gradle%E5%AD%A6%E4%B9%A0.html","title":"Gradle学习","lang":"zh-CN","frontmatter":{"data":"2024-07-10T00:00:00.000Z","tags":["构建工具"],"关联":["[[Java开发]]"],"description":"Gradle学习 第三包管理历史 早期没有项目管理工具时，对于项目所依赖的第三方包采用的事：拷贝三方jar包到本地，然后加入到lib目录下，这样做劣势不言而喻，管理复杂容易冲突。 后面就出现了第三方包管理工具 Ant：2000年发布，纯java编写. Maven：2004年发布，采用pom.xml管理项目 Gradle：2012年，google背书的一...","gitInclude":[],"head":[["meta",{"property":"og:url","content":"https://tvt-dog.github.io/TvT-dog/%E5%BC%80%E5%8F%91/Java%E5%BC%80%E5%8F%91/Gradle%E5%AD%A6%E4%B9%A0.html"}],["meta",{"property":"og:site_name","content":"Ho1d_F0rward的知识库"}],["meta",{"property":"og:title","content":"Gradle学习"}],["meta",{"property":"og:description","content":"Gradle学习 第三包管理历史 早期没有项目管理工具时，对于项目所依赖的第三方包采用的事：拷贝三方jar包到本地，然后加入到lib目录下，这样做劣势不言而喻，管理复杂容易冲突。 后面就出现了第三方包管理工具 Ant：2000年发布，纯java编写. Maven：2004年发布，采用pom.xml管理项目 Gradle：2012年，google背书的一..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:image","content":"https://cdn.nlark.com/yuque/0/2024/png/27874700/1720611438865-d5875f74-5309-4b04-a29b-11862a69c6ab.png"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"article:tag","content":"构建工具"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"Gradle学习\\",\\"image\\":[\\"https://cdn.nlark.com/yuque/0/2024/png/27874700/1720611438865-d5875f74-5309-4b04-a29b-11862a69c6ab.png\\"],\\"dateModified\\":null,\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"Ho1d_F0rward\\",\\"url\\":\\"https://tvt-dog.github.io/TvT-dog/\\",\\"email\\":\\"outlook_39ae1e67a9a1791b@outlook.com\\"}]}"]]},"headers":[{"level":2,"title":"第三包管理历史","slug":"第三包管理历史","link":"#第三包管理历史","children":[]},{"level":2,"title":"项目结构","slug":"项目结构","link":"#项目结构","children":[]},{"level":2,"title":"Project","slug":"project","link":"#project","children":[{"level":3,"title":"属性设置","slug":"属性设置","link":"#属性设置","children":[]},{"level":3,"title":"方法","slug":"方法","link":"#方法","children":[]},{"level":3,"title":"插件","slug":"插件","link":"#插件","children":[]}]},{"level":2,"title":"任务","slug":"任务","link":"#任务","children":[]},{"level":2,"title":"生命周期","slug":"生命周期","link":"#生命周期","children":[]}],"readingTime":{"minutes":9.3,"words":2790},"filePathRelative":"开发/Java开发/Gradle学习.md","autoDesc":true}');export{c as comp,o as data};
