import{_ as s}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as a,d as i,o as e}from"./app-B60ElMD-.js";const l={};function p(t,n){return e(),a("div",null,n[0]||(n[0]=[i(`<h1 id="安卓架构" tabindex="-1"><a class="header-anchor" href="#安卓架构"><span>安卓架构</span></a></h1><p>![[images/Pasted image 20240916164832.png]]<br> 总的来说可以分为5层</p><h2 id="linux内核层" tabindex="-1"><a class="header-anchor" href="#linux内核层"><span>linux内核层</span></a></h2><p>Android 平台的基础是 Linux 内核。为整个系统提供了基础功能，如文件管理，进程调用等。</p><h2 id="硬件抽象层" tabindex="-1"><a class="header-anchor" href="#硬件抽象层"><span>硬件抽象层</span></a></h2><p>即将各种硬件抽象为一个个可以被程序使用的标准接口。</p><h2 id="native系统库与android-runtime" tabindex="-1"><a class="header-anchor" href="#native系统库与android-runtime"><span>Native系统库与Android Runtime</span></a></h2><p>Native系统库即使用c或者c++编写的一些库，实现了安卓的核心功能。为java提供了一些方法来进行调用，简化开发.<br> Android Runtime可以简单理解为特别定制的一种jvm虚拟机。</p><h2 id="java-api-框架" tabindex="-1"><a class="header-anchor" href="#java-api-框架"><span>Java API 框架</span></a></h2><p>即使用java对各种功能进行了再次抽象，来简化开发。</p><h2 id="系统应用" tabindex="-1"><a class="header-anchor" href="#系统应用"><span>系统应用</span></a></h2><p>这里既为我们平时安装使用的app了。</p><h1 id="app架构" tabindex="-1"><a class="header-anchor" href="#app架构"><span>APP架构</span></a></h1><p>![[images/Pasted image 20240916185148.png]]</p><ul><li>界面层：<br> 用于显示数据,同时当数据进行变化时，界面也要进行对应的一个变化。</li><li>数据层 ：<br> 包含应用的业务逻辑并公开应用数据，数据层由多个仓库组成，其中每个仓库都可以包含零到多个数据源。</li><li>网域层：<br> 以简化和重复使用界面层与数据层之间的交互，封装复杂的业务逻辑。</li></ul><h1 id="项目结构" tabindex="-1"><a class="header-anchor" href="#项目结构"><span>项目结构</span></a></h1><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>MyAndroidProject/</span></span>
...
<span class="line"><span>    }  </span></span>
<span class="line"><span>}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>动态注册的BroadcastReceiver可以自由地控制注册与注销，在灵活性方面有很大的优势。但<br> 是它存在着一个缺点，即必须在程序启动之后才能接收广播，因为注册的逻辑是写在<br> onCreate()方法中的</p><h4 id="静态注册" tabindex="-1"><a class="header-anchor" href="#静态注册"><span>静态注册</span></a></h4><p>编写对应的一个逻辑：</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>class MyReceiver : BroadcastReceiver() {  </span></span>
<span class="line"><span>  </span></span>
<span class="line"><span>    override fun onReceive(context: Context, intent: Intent) {  </span></span>
...
<span class="line"><span>    }  </span></span>
<span class="line"><span>}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>注意这里需要将其注册进行AndroidManifest.xml文件中</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>&lt;receiver  </span></span>
...
<span class="line"><span>    }  </span></span>
<span class="line"><span>  </span></span>
<span class="line"><span>}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这样即可实现</p><h2 id="contentprovider使用" tabindex="-1"><a class="header-anchor" href="#contentprovider使用"><span>ContentProvider使用</span></a></h2><p>Content Provider是Android应用中的一种组件，用于管理和共享应用数据。它为其他应用提供了一种安全的、标准化的方式来访问数据。、</p><p>在业务中承担的角色：</p><ul><li>数据共享: 允许一个应用访问另一个应用的数据，这对于多应用之间的数据交互非常重要。</li><li>抽象数据存储: 提供统一的接口来访问不同类型的数据源，如SQLite数据库、文件系统或网络。</li><li>安全性: 通过权限控制，确保只有授权的应用才能访问特定的数据。</li></ul><p>ContentProvider的用法一般有两种：一种是使用现有的ContentProvider读取和操作相应程<br> 序中的数据；另一种是创建自己的ContentProvider，给程序的数据提供外部访问接口。</p><h3 id="权限处理" tabindex="-1"><a class="header-anchor" href="#权限处理"><span>权限处理</span></a></h3><p>在我们读取其他数据之前，我们首先要处理的是权限的问题。比如我们读取照片和电话信息时，app都会跳出对应的弹窗要求我们授予对应的权限。</p><p>流程可以大概分为：</p><ul><li>在Manifest中声明权限。</li><li>检查是否已获得权限。</li><li>如果未获得权限，申请权限。</li><li>处理用户的授权结果。</li></ul><h4 id="声明权限" tabindex="-1"><a class="header-anchor" href="#声明权限"><span>声明权限</span></a></h4><p>我们首先要声明权限，即安装时就要求拥有的权限.</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>&lt;uses-permission android:name=&quot;android.permission.READ_CONTACTS&quot; /&gt;</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div><h4 id="检查权限" tabindex="-1"><a class="header-anchor" href="#检查权限"><span>检查权限</span></a></h4><p>这里要使用的函数为checkSelfPermission函数</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>public static int checkSelfPermission(@NonNull Context context, @NonNull String permission)</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div><p>参数</p><ul><li>context: 当前的上下文，通常是 Activity 或 Application。</li><li>permission: 要检查的权限字符串，例如 Manifest.permission.CAMERA。</li></ul><p>返回值</p><ul><li>返回 PackageManager.PERMISSION_GRANTED (值为 0) 表示权限已获得。</li><li>返回 PackageManager.PERMISSION_DENIED (值为 -1) 表示权限未获得。</li></ul><h4 id="申请权限" tabindex="-1"><a class="header-anchor" href="#申请权限"><span>申请权限</span></a></h4><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>public void requestPermissions(@NonNull String[] permissions, int requestCode)</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div><p>参数</p><ul><li>permissions: 一个字符串数组，包含要请求的权限。</li><li>requestCode: 一个整型值，用于标识这个请求，以便在回调中处理。</li></ul><h4 id="处理授权结果" tabindex="-1"><a class="header-anchor" href="#处理授权结果"><span>处理授权结果</span></a></h4><p>当用户做出权限选择后，系统会调用这个方法。</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>@Override</span></span>
<span class="line"><span>public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults)</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>requestCode: 之前传递的请求代码。</li><li>permissions: 请求的权限数组。</li><li>grantResults: 权限请求的结果数组，其中每个元素对应于 permissions 数组的元素，值为 PackageManager.PERMISSION_GRANTED 或 PackageManager.PERMISSION_DENIED。</li></ul><h4 id="完整代码示例" tabindex="-1"><a class="header-anchor" href="#完整代码示例"><span>完整代码示例</span></a></h4><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>package com.example.permissionexample</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>    }  </span></span>
<span class="line"><span>}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这里使用了getColumnIndex方法，使用列名ContactsContract.Contacts.CONTACT_STATUS来获取对应的一个索引。</p><h1 id="webview使用" tabindex="-1"><a class="header-anchor" href="#webview使用"><span>WebView使用</span></a></h1><p>WebView 是一种用于在应用程序中显示网页内容的组件，常用于 Android 和 iOS 开发。它允许开发者在本地应用程序中嵌入网页浏览功能，而不需要打开系统浏览器。</p><h2 id="网页加载" tabindex="-1"><a class="header-anchor" href="#网页加载"><span>网页加载</span></a></h2><h3 id="url加载" tabindex="-1"><a class="header-anchor" href="#url加载"><span>url加载</span></a></h3><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>myWebView.loadUrl(&quot;https://www.example.com&quot;)</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div><h3 id="直接加载数据" tabindex="-1"><a class="header-anchor" href="#直接加载数据"><span>直接加载数据</span></a></h3><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>val htmlData = &quot;&lt;html&gt;&lt;body&gt;&lt;h1&gt;Hello, WebView!&lt;/h1&gt;&lt;/body&gt;&lt;/html&gt;&quot;</span></span>
<span class="line"><span>myWebView.loadData(htmlData, &quot;text/html&quot;, &quot;UTF-8&quot;)</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="网页控制" tabindex="-1"><a class="header-anchor" href="#网页控制"><span>网页控制</span></a></h2><ul><li>goBack():返回到上一个网页。</li><li>goForward():返回到下一个网页。</li><li>reload():重新加载当前网页。</li></ul><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>if (myWebView.canGoBack()) {</span></span>
...
<span class="line"><span>}</span></span>
<span class="line"><span>myWebView.reload()</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="javascript使用-jsbridge" tabindex="-1"><a class="header-anchor" href="#javascript使用-jsbridge"><span>JavaScript使用(JSBridge)</span></a></h2><h3 id="启用-javascript交互权限" tabindex="-1"><a class="header-anchor" href="#启用-javascript交互权限"><span>启用 JavaScript交互权限</span></a></h3><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>	myWebView.settings.javaScriptEnabled = true\`</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div><h3 id="安卓调用javascript" tabindex="-1"><a class="header-anchor" href="#安卓调用javascript"><span>安卓调用javascript</span></a></h3><p>有以下两种方法可以进行执行</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>WebView.loadUrl(String url);</span></span>
<span class="line"><span>WebView.evaluateJavascript(String script, ValueCallback&lt;String&gt; resultCallback);	// android 4.4增加</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div></div></div><p>即直接加载对应的url，或者是手动传入javascript代码。</p><h4 id="示例代码" tabindex="-1"><a class="header-anchor" href="#示例代码"><span>示例代码</span></a></h4><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>import android.os.Bundle</span></span>
...
<span class="line"><span>        }</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span>}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>src/main/assets 目录下创建一个名为 sample.html 的文件</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>&lt;!DOCTYPE html&gt;</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="创建接口" tabindex="-1"><a class="header-anchor" href="#创建接口"><span>创建接口</span></a></h5><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>myWebView.addJavascriptInterface(MyJavaScriptInterface(this), &quot;AndroidInterface&quot;)</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div><h5 id="javascript-调用" tabindex="-1"><a class="header-anchor" href="#javascript-调用"><span>JavaScript 调用</span></a></h5><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>function callAndroid() {</span></span>
...
<span class="line"><span>}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="示例代码-1" tabindex="-1"><a class="header-anchor" href="#示例代码-1"><span>示例代码</span></a></h5><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>  </span></span>
<span class="line"><span>class MainActivity : AppCompatActivity() {  </span></span>
<span class="line"><span>  </span></span>
<span class="line"><span>    private lateinit var myWebView: WebView  </span></span>
<span class="line"><span>  </span></span>
...
<span class="line"><span>&lt;/RelativeLayout&gt;</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="请求拦截" tabindex="-1"><a class="header-anchor" href="#请求拦截"><span>请求拦截</span></a></h4><p>houldOverrideUrlLoading 是 Android 中 WebViewClient 类的一个方法，用于拦截和处理 WebView 中的 URL 加载请求。通过重写这个方法，开发者可以控制 URL 的加载行为，例如在特定条件下拦截请求、打开外部浏览器、或处理自定义 URL scheme。</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>override fun shouldOverrideUrlLoading(view: WebView, request: WebResourceRequest): Boolean</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div><p>参数：</p><ul><li>view: WebView: 当前的 WebView 实例。</li><li>request: WebResourceRequest: 包含请求信息的对象，包括 URL、HTTP 方法等。<br> 返回值：<br> Boolean: 如果返回 true，表示你已经处理了这个请求，WebView 不会继续加载该 URL；如果返回 false，表示 WebView 将继续加载该 URL。</li></ul><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>class MyWebViewClient : WebViewClient() {</span></span>
...
<span class="line"><span>    &lt;/script&gt;</span></span>
<span class="line"><span>&lt;/body&gt;</span></span>
<span class="line"><span>&lt;/html&gt;</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="app唤醒" tabindex="-1"><a class="header-anchor" href="#app唤醒"><span>App唤醒</span></a></h1><h2 id="url-scheme" tabindex="-1"><a class="header-anchor" href="#url-scheme"><span>url scheme</span></a></h2><p>URL scheme（也称为深度链接）可以让其他应用或网页通过特定的 URL 打开你的应用。这里是基本的格式</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>&lt;scheme&gt;://&lt;host&gt;:&lt;port&gt;/&lt;path&gt;?&lt;query&gt;#&lt;fragment&gt;</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div><p>其中的<code>&lt;scheme&gt;://&lt;host&gt;</code>即为定位对应app的</p><p>首先我们配置对应的AndroidManifest.xml，来设置意图过滤器</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>&lt;intent-filter&gt;</span></span>
...
<span class="line"><span>    &lt;/intent-filter&gt;</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="唤醒app代码" tabindex="-1"><a class="header-anchor" href="#唤醒app代码"><span>唤醒app代码</span></a></h3><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>class MainActivity : AppCompatActivity() {</span></span>
...
<span class="line"><span>        android:layout_width=&quot;match_parent&quot;</span></span>
<span class="line"><span>        android:layout_height=&quot;match_parent&quot; /&gt;</span></span>
<span class="line"><span>&lt;/LinearLayout&gt;</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="被唤醒app代码" tabindex="-1"><a class="header-anchor" href="#被唤醒app代码"><span>被唤醒app代码</span></a></h3><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>  </span></span>
<span class="line"><span>class MainActivity : AppCompatActivity() {  </span></span>
<span class="line"><span>    override fun onCreate(savedInstanceState: Bundle?) {  </span></span>
<span class="line"><span>        super.onCreate(savedInstanceState)  </span></span>
<span class="line"><span>        setContentView(R.layout.activity_main)  </span></span>
...
<span class="line"><span>  </span></span>
<span class="line"><span>&lt;/LinearLayout&gt;</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="intent-based-uri" tabindex="-1"><a class="header-anchor" href="#intent-based-uri"><span>intent-based URI</span></a></h2><p>是一种特殊格式的 URI（统一资源标识符），用于在 Android 中通过 Intent 启动应用并传递数据。它结合了标准的 URI 格式和 Intent 的描述信息。<br> 和URL Scheme的区别是<br> Intent-based URI 提供了更强大的功能和灵活性，适合复杂的 Android 应用间交互。仅支持在Android平台使用。</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>intent://&lt;host&gt;/&lt;path&gt;?&lt;query&gt;#Intent;scheme=&lt;scheme&gt;;package=&lt;package_name&gt;;end;</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div><ul><li>主机（host）:<br> 指定要访问的主机，例如 <a href="http://kuaishou.com" target="_blank" rel="noopener noreferrer">kuaishou.com</a>。</li><li>路径（path）:<br> 表示特定的资源或功能，例如 /view/c/c/c。</li><li>查询参数（query）:<br> 以 ? 开头，用于传递额外的数据，例如 id=223。</li><li>Fragment（锚点）部分:<br> 以 Intent; 开头，后面跟随 Intent 的详细描述。</li><li>Intent 描述:<br> scheme=: 指定要使用的 URL scheme（如 myapp）。<br> package=: 指定要启动的目标应用的包名（如 com.example.targetapp）。<br> end;: 表示 Intent 描述的结束。</li></ul><h3 id="唤醒app代码-1" tabindex="-1"><a class="header-anchor" href="#唤醒app代码-1"><span>唤醒app代码</span></a></h3><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>class MainActivity : AppCompatActivity() {</span></span>
<span class="line"><span>    private lateinit var webView: WebView</span></span>
<span class="line"><span></span></span>
<span class="line"><span>    override fun onCreate(savedInstanceState: Bundle?) {</span></span>
<span class="line"><span>        super.onCreate(savedInstanceState)</span></span>
...
<span class="line"><span>  }</span></span>
<span class="line"><span>}]</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>package_name 需要你修改成你自己的包名；</li><li>sha256_cert_fingerprints 需要获取你的apk 的sha-256签名</li></ul><h3 id="客户端配置" tabindex="-1"><a class="header-anchor" href="#客户端配置"><span>客户端配置</span></a></h3><p>配置对应的服务端网址</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>&lt;activity android:name=&quot;.MainActivity&quot;&gt; &lt;intent-filter android:autoVerify=&quot;true&quot;&gt; &lt;action android:name=&quot;android.intent.action.VIEW&quot; /&gt; &lt;category android:name=&quot;android.intent.category.DEFAULT&quot; /&gt; &lt;category android:name=&quot;android.intent.category.BROWSABLE&quot; /&gt; &lt;data android:scheme=&quot;https&quot; android:host=&quot;www.example.com&quot; /&gt; &lt;/intent-filter&gt; &lt;/activity&gt;</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div><p>编写一个简单的Activity来接收url数据</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>import android.content.Intent</span></span>
<span class="line"><span>import android.net.Uri</span></span>
<span class="line"><span>import android.os.Bundle</span></span>
<span class="line"><span>import android.widget.TextView</span></span>
<span class="line"><span>import androidx.appcompat.app.AppCompatActivity</span></span>
...
<span class="line"><span>        android:layout_height=&quot;wrap_content&quot;</span></span>
<span class="line"><span>        android:textSize=&quot;18sp&quot; /&gt;</span></span>
<span class="line"><span>&lt;/RelativeLayout&gt;</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这样访问 <a href="https://www.example.com/?id=223&amp;name=jack" target="_blank" rel="noopener noreferrer">https://www.example.com/?id=223&amp;name=jack</a> 的链接。应用就会自动打开，并显示传递的 ID 和名称。</p><h2 id="webview访问本app内其他组件" tabindex="-1"><a class="header-anchor" href="#webview访问本app内其他组件"><span>webview访问本app内其他组件</span></a></h2><h3 id="唤醒app代码-2" tabindex="-1"><a class="header-anchor" href="#唤醒app代码-2"><span>唤醒app代码</span></a></h3><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>class MainActivity : AppCompatActivity() {</span></span>
<span class="line"><span>    private lateinit var webView: WebView</span></span>
<span class="line"><span></span></span>
<span class="line"><span>    override fun onCreate(savedInstanceState: Bundle?) {</span></span>
<span class="line"><span>        super.onCreate(savedInstanceState)</span></span>
...
<span class="line"><span>        &quot;&quot;&quot;</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span>}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>同时你会发现如果把注释去掉，你会发现此时就无法调用其他组件了。</p><p>底层原因是如果未指定webviewClient，就给android处理。android系统会在系统中寻找注册了https scheme的app。</p><p>如果你指定了webviewClient,那么就由你指定的这个webviewClient来处理，这里的webviewClien就要你自己编写了对应的Intent URI处理逻辑，才会进行打开对应的组件了。</p><h1 id="参考链接" tabindex="-1"><a class="header-anchor" href="#参考链接"><span>参考链接</span></a></h1><p><a href="https://developer.android.com/codelabs/basic-android-kotlin-compose-first-app?continue=https%3A%2F%2Fdeveloper.android.com%2Fcourses%2Fpathways%2Fandroid-basics-compose-unit-1-pathway-2%23codelab-https%3A%2F%2Fdeveloper.android.com%2Fcodelabs%2Fbasic-android-kotlin-compose-first-app&amp;%3Bhl=zh-cn&amp;hl=zh-cn#4" target="_blank" rel="noopener noreferrer">https://developer.android.com/codelabs/basic-android-kotlin-compose-first-app?continue=https%3A%2F%2Fdeveloper.android.com%2Fcourses%2Fpathways%2Fandroid-basics-compose-unit-1-pathway-2%23codelab-https%3A%2F%2Fdeveloper.android.com%2Fcodelabs%2Fbasic-android-kotlin-compose-first-app&amp;%3Bhl=zh-cn&amp;hl=zh-cn#4</a></p>`,196)]))}const c=s(l,[["render",p]]),v=JSON.parse('{"path":"/docs/%E5%BC%80%E5%8F%91/%E5%AE%89%E5%8D%93/%E5%AE%89%E5%8D%93%E5%AD%A6%E4%B9%A0.html","title":"安卓架构","lang":"zh-CN","frontmatter":{"data":"2024-06-25T00:00:00.000Z","关联":["[[知识/知识笔记/开发/安卓/安卓|安卓]]"],"description":"安卓架构 ![[images/Pasted image 20240916164832.png]] 总的来说可以分为5层 linux内核层 Android 平台的基础是 Linux 内核。为整个系统提供了基础功能，如文件管理，进程调用等。 硬件抽象层 即将各种硬件抽象为一个个可以被程序使用的标准接口。 Native系统库与Android Runtime ...","head":[["meta",{"property":"og:url","content":"https://f0rward.fun/docs/%E5%BC%80%E5%8F%91/%E5%AE%89%E5%8D%93/%E5%AE%89%E5%8D%93%E5%AD%A6%E4%B9%A0.html"}],["meta",{"property":"og:title","content":"安卓架构"}],["meta",{"property":"og:description","content":"安卓架构 ![[images/Pasted image 20240916164832.png]] 总的来说可以分为5层 linux内核层 Android 平台的基础是 Linux 内核。为整个系统提供了基础功能，如文件管理，进程调用等。 硬件抽象层 即将各种硬件抽象为一个个可以被程序使用的标准接口。 Native系统库与Android Runtime ..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2025-04-04T09:31:55.000Z"}],["meta",{"property":"article:modified_time","content":"2025-04-04T09:31:55.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"安卓架构\\",\\"image\\":[\\"\\"],\\"dateModified\\":\\"2025-04-04T09:31:55.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"Ho1d_F0rward\\",\\"url\\":\\"https://f0rward.fun/\\"}]}"]]},"git":{"createdTime":1743759115000,"updatedTime":1743759115000,"contributors":[{"name":"tangyijie.666","username":"","email":"tangyijie.666@bytedance.com","commits":1}]},"readingTime":{"minutes":21.19,"words":6358},"filePathRelative":"docs/开发/安卓/安卓学习.md","localizedDate":"2025年4月4日","excerpt":"\\n<p>![[images/Pasted image 20240916164832.png]]<br>\\n总的来说可以分为5层</p>\\n<h2>linux内核层</h2>\\n<p>Android 平台的基础是 Linux 内核。为整个系统提供了基础功能，如文件管理，进程调用等。</p>\\n<h2>硬件抽象层</h2>\\n<p>即将各种硬件抽象为一个个可以被程序使用的标准接口。</p>\\n<h2>Native系统库与Android Runtime</h2>\\n<p>Native系统库即使用c或者c++编写的一些库，实现了安卓的核心功能。为java提供了一些方法来进行调用，简化开发.<br>\\nAndroid Runtime可以简单理解为特别定制的一种jvm虚拟机。</p>","autoDesc":true}');export{c as comp,v as data};
