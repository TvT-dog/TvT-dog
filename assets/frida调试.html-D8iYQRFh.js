import{_ as s}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as a,d as e,o as i}from"./app-C9BbSHvW.js";const l={};function p(d,n){return i(),a("div",null,n[0]||(n[0]=[e(`<h1 id="frida调试" tabindex="-1"><a class="header-anchor" href="#frida调试"><span>frida调试</span></a></h1><h2 id="基本概念" tabindex="-1"><a class="header-anchor" href="#基本概念"><span>基本概念</span></a></h2><p><code>frida</code>是平台原生<code>app</code>的<code>Greasemonkey</code>，说的专业一点，就是一种动态插桩工具，可以插入一些代码到原生<code>app</code>的内存空间去，（动态地监视和修改其行为），这些原生平台可以是<code>Win</code>、<code>Mac</code>、<code>Linux</code>、<code>Android</code>或者<code>iOS</code>。而且<code>frida</code>还是开源的。</p><p><code>Greasemonkey</code>可能大家不明白，它其实就是<code>firefox</code>的一套插件体系，使用它编写的脚本可以直接改变<code>firefox</code>对网页的编排方式，实现想要的任何功能。而且这套插件还是外挂的，非常灵活机动。<code>frida</code>也是一样的道理。在一个js代码中学习我们的一个hook逻辑，然后再python进行相关一个运行。</p><h2 id="安装教程" tabindex="-1"><a class="header-anchor" href="#安装教程"><span>安装教程</span></a></h2><p>https://www.cnblogs.com/eliwang/p/17729247.html</p><h2 id="java层hook代码编写" tabindex="-1"><a class="header-anchor" href="#java层hook代码编写"><span>JAVA层Hook代码编写</span></a></h2><p>这里我们主要会用到Java.perform来进行相关处理。</p><p><code>Java.perform()</code> 是 Frida 框架提供的一个重要 API,用于在 Android 应用程序的 Java 运行时环境中执行代码。</p><ul><li><code>Java.perform()</code> 方法接受一个回调函数作为参数,该函数包含要执行的 Java 代码。</li><li>回调函数内部可以使用各种 Frida API 来与 Java 运行时进行交互,例如: <ul><li><code>Java.use()</code>: 获取 Java 类的引用</li><li><code>Java.choose()</code>: 枚举正在运行的 Java 对象</li><li><code>Java.cast()</code>: 类型转换</li><li><code>Java.field()</code> 和 <code>Java.method()</code>: 访问类的字段和方法</li></ul></li></ul><h3 id="app定位" tabindex="-1"><a class="header-anchor" href="#app定位"><span>app定位</span></a></h3><p>我们一般使用frida.get_device和attach方法来连接上 frida-server并确定对应的app程序。 <code>get_device()</code>我们一般为空，它可以自动检测连接到的安卓设备。</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>device = frida.get_device()</span></span>
<span class="line"><span>app = device.attach(package_name)</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="hook参数、修改结果" tabindex="-1"><a class="header-anchor" href="#hook参数、修改结果"><span>hook参数、修改结果</span></a></h3><p>我们一般使用Java.use()来确实具体的一个类。然后使用implementation方法来更换对应的一个方法体。</p><p>如下代码即为替换com.roysue.demo02.MainActivity类中的implementation方法</p><p>app代码</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>public class MainActivity extends AppCompatActivity {  </span></span>
...
<span class="line"><span>    }  </span></span>
<span class="line"><span>  </span></span>
<span class="line"><span>}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>js代码</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>console.log(&quot;Script loaded successfully &quot;);  </span></span>
...
<span class="line"><span>    }  </span></span>
<span class="line"><span>});</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>我们再使用python进行加载</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>import frida  </span></span>
<span class="line"><span>  </span></span>
...
<span class="line"><span>input()</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="hook重载函数与隐藏函数" tabindex="-1"><a class="header-anchor" href="#hook重载函数与隐藏函数"><span>hook重载函数与隐藏函数</span></a></h3><p>我们使用overload()来实现对特定函数的获取，Java.choose()方法来获取隐藏函数。</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>console.log(&quot;Script loaded successfully &quot;);  </span></span>
<span class="line"><span>Java.perform(function x() {  </span></span>
<span class="line"><span>    console.log(&quot;Inside java perform function&quot;);  </span></span>
<span class="line"><span>    //定位类  </span></span>
<span class="line"><span>    var my_class = Java.use(&quot;com.example.frida.MainActivity&quot;);  </span></span>
...
<span class="line"><span>rpc.exports = {  </span></span>
<span class="line"><span>    callsecretfunction: callSecretFun //把callSecretFun函数导出为callsecretfunction符号，导出名不可以有大写字母或者下划线  </span></span>
<span class="line"><span>};</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>然后在pytho使用 script.exports_sync.callsecretfunction()进行一个对应的调用</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>import time  </span></span>
<span class="line"><span>import frida  </span></span>
<span class="line"><span>  </span></span>
<span class="line"><span>  </span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>});</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,42)]))}const r=s(l,[["render",p],["__file","frida调试.html.vue"]]),o=JSON.parse('{"path":"/%E5%BC%80%E5%8F%91/%E5%AE%89%E5%8D%93/frida%E8%B0%83%E8%AF%95.html","title":"frida调试","lang":"zh-CN","frontmatter":{"data":"2024-06-27T00:00:00.000Z","tags":["安卓"],"关联":["[[安卓学习]]"],"博客链接":"https:/www.cnblogs.com/Ho1dF0rward/p/18364741","description":"frida调试 基本概念 frida是平台原生app的Greasemonkey，说的专业一点，就是一种动态插桩工具，可以插入一些代码到原生app的内存空间去，（动态地监视和修改其行为），这些原生平台可以是Win、Mac、Linux、Android或者iOS。而且frida还是开源的。 Greasemonkey可能大家不明白，它其实就是firefox的一...","gitInclude":[],"head":[["meta",{"property":"og:url","content":"https://tvt-dog.github.io/TvT-dog/%E5%BC%80%E5%8F%91/%E5%AE%89%E5%8D%93/frida%E8%B0%83%E8%AF%95.html"}],["meta",{"property":"og:site_name","content":"Ho1d_F0rward的知识库"}],["meta",{"property":"og:title","content":"frida调试"}],["meta",{"property":"og:description","content":"frida调试 基本概念 frida是平台原生app的Greasemonkey，说的专业一点，就是一种动态插桩工具，可以插入一些代码到原生app的内存空间去，（动态地监视和修改其行为），这些原生平台可以是Win、Mac、Linux、Android或者iOS。而且frida还是开源的。 Greasemonkey可能大家不明白，它其实就是firefox的一..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"article:tag","content":"安卓"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"frida调试\\",\\"image\\":[\\"\\"],\\"dateModified\\":null,\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"Ho1d_F0rward\\",\\"url\\":\\"https://tvt-dog.github.io/TvT-dog/\\",\\"email\\":\\"outlook_39ae1e67a9a1791b@outlook.com\\"}]}"]]},"headers":[{"level":2,"title":"基本概念","slug":"基本概念","link":"#基本概念","children":[]},{"level":2,"title":"安装教程","slug":"安装教程","link":"#安装教程","children":[]},{"level":2,"title":"JAVA层Hook代码编写","slug":"java层hook代码编写","link":"#java层hook代码编写","children":[{"level":3,"title":"app定位","slug":"app定位","link":"#app定位","children":[]},{"level":3,"title":"hook参数、修改结果","slug":"hook参数、修改结果","link":"#hook参数、修改结果","children":[]},{"level":3,"title":"hook重载函数与隐藏函数","slug":"hook重载函数与隐藏函数","link":"#hook重载函数与隐藏函数","children":[]},{"level":3,"title":"远程调用","slug":"远程调用","link":"#远程调用","children":[]}]},{"level":2,"title":"Native 层Hook代码编写","slug":"native-层hook代码编写","link":"#native-层hook代码编写","children":[{"level":3,"title":"so文件与函数的定位","slug":"so文件与函数的定位","link":"#so文件与函数的定位","children":[]},{"level":3,"title":"hook对应函数","slug":"hook对应函数","link":"#hook对应函数","children":[]}]}],"readingTime":{"minutes":4.68,"words":1404},"filePathRelative":"开发/安卓/frida调试.md","autoDesc":true}');export{r as comp,o as data};
